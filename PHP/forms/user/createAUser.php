<div id="CreateAUser" class="subgroup well"> 
  ...
  <form class="form-horizontal" name="createAUserForm" id="createAUserForm" method="post" action="createAUser()">
    <fieldset>
      <p><b>Note:</b> Create A User XML Response and Create A User JSON Response will return the expected responses but will not check if they are valid.</p>
    <!-- Create A User Form -->
    <legend class="ZoomBlue">Create A User Example</legend>

    <!-- Email input field -->
    <div class="form-group">
      <label class="col-md-4 control-label" for="createAUserEmail">User Email</label>  
      <div class="col-md-4">
      <input id="createAUserEmail" name="createAUserEmail" placeholder="youremail@domain.com" type="email" class="form-control input-md" required="" onchange="createAUserEmailChange()">
